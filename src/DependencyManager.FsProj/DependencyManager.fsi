...
module FsProjDependencyManager =
    val getAllDependentProjects : string list -> string list
    val getSourceFilesForProject : string -> string list
    val getPackageReferencesForProjects : string list -> PackageReference list
    
    val toNugetPackageReference: PackageReference -> string
    val toLoadSourceLine: string -> string
...
[<DependencyManager>]
type FsProjDependencyManager =
    new: outputDirectory: string option * useResultsCache: bool -> FsProjDependencyManager
    new: outputDirectory: string option -> FsProjDependencyManager
